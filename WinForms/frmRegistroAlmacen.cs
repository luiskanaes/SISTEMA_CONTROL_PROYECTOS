...
namespace WinForms
{
    public partial class frmRegistroAlmacen : Form
    {
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            dtResultado = obj.SP_CONSULTAR_DATOS_ALMACEN("", txtUnit.Text, txtLine.Text, txtTrain.Text, txtServicio.Text, cboFiltro.SelectedValue.ToString(), txtFiltro.Text, cboFamilia.SelectedValue.ToString());
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                using (SqlConnection con = new SqlConnection(consString))
                {
                    using (SqlBulkCopy sqlBulkCopy = new SqlBulkCopy(con))
                    {
                        ...
                        BL_MARCAS obj = new BL_MARCAS();
                        DataTable dtResultado = new DataTable();
                        dtResultado = obj.SP_GUARDAR_DATOS_REGISTRO_ALMACEN("", str);
        ...
        private void lblCabecera_Click(object sender, EventArgs e)
        {
