...
namespace WinForms
{
    public partial class frmManPowerEspecialidad : Form
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["Conexion"].ToString());
        public frmManPowerEspecialidad()
        {
            InitializeComponent();
            ListarEmpresa();
        }

        private void frmManPowerEspecialidad_Load(object sender, EventArgs e)
        {
        ...
        private DataTable GetData()
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_REPORTE_MANPOWER_CATEGORIA_ESP", con);
