...
namespace WinForms
{
    public partial class RptHHPeriodo : Form
    {
        ...
        private void RptHHPeriodo_Load(object sender, EventArgs e)
        {
        ...
        private DataTable GetData()
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_RPT_TAREO_DEL_DIA_PERIODO", con);
