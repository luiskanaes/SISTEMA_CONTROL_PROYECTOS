...
namespace WinForms
{
    public partial class frmReportesGeneradorSpool : Form
    {
        public frmReportesGeneradorSpool()
        {
            InitializeComponent(); cargarTipoJunta();
        }
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            dtResultado = obj.SP_CONSULTAR_REPORTES_SPOOL(cboReporte.SelectedValue.ToString());
        ...
        {
            {1,"Elementos En Linea (Base de datos completa)"}
