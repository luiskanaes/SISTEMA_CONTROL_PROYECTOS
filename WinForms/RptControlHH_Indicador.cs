...
namespace WinForms
{
    public partial class RptControlHH_Indicador : Form
    {
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["Conexion"].ToString());
        public RptControlHH_Indicador()
        {
            InitializeComponent();
        }

        private void RptControlHH_Indicador_Load(object sender, EventArgs e)
        {
        ...
        private DataTable GetData()
        {
            ...
            SqlCommand cmd = new SqlCommand("SP_RPT_CONTROL_HH_INDICADOR", con);
            ...
            cmd.Parameters.Add("@FECHA_INICIO", SqlDbType.VarChar, 10).Value = dateFecha.Value.Date.ToString("dd/MM/yyyy");
